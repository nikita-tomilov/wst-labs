...
//        switch (command) {
//          case FIND_ALL:
//            userPort.findAll().stream().map(ClientNoJuddi::userToString)
...
//                .stream().map(ClientNoJuddi::userToString).forEach(System.out::println);
//            break;
//          case INSERT:
